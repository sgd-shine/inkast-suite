...
export function KeyboardShortcutsHelp() {
	...
	return (
		<div className="relative group">
			...
			<div className="absolute right-0 top-full mt-2 w-64 bg-[#0A0C0E] border border-white/10 rounded-lg p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 shadow-xl z-50">
