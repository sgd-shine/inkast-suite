...
export function UnsavedChangesDialog({
	...
	return (
		<Dialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
			<DialogContent className="bg-[#0A0C0E] border-white/10 rounded-2xl max-w-sm p-6 gap-0">
				...
				<div className="flex flex-col gap-2">
					<button
						...
						className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg bg-[#34B27B] hover:bg-[#2d9e6c] active:bg-[#27885c] text-white font-medium text-sm transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#34B27B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0C0E]"
					>
					...
					<button
						type="button"
						onClick={onCancel}
						className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg hover:bg-white/5 text-slate-500 hover:text-slate-300 font-medium text-sm transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0C0E]"
					>
						{tc("actions.cancel")}
					</button>
				</div>
